...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnapEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty movementType, movementAxis, setAsLastSibling, automaticallyLayout, sizeControl, size, automaticLayoutSpacing, leftMargin, rightMargin, topMargin, bottomMargin, infinitelyScroll, infiniteScrollingEndSpacing, startingPanel, swipeGestures, minimumSwipeSpeed, previousButton, nextButton, pagination, toggleNavigation, snapTarget, snappingSpeed, useUnscaledTime, useOcclusionCulling, thresholdSnappingSpeed, hardSnap, onPanelSelecting, onPanelSelected, onPanelChanging, onPanelChanged;
        ...
        private void OnEnable()
        {
            ...
            setAsLastSibling = serializedObject.FindProperty("setAsLastSibling");
        ...
        {
            EditorGUILayout.PropertyField(setAsLastSibling, new GUIContent("Draw in reverse layout"));
