...
namespace PolyAndCode.UI
{
    ...
    public class RecyclableScrollRectEditor : UnityEditor.Editor
    {
		...
		SerializedProperty _changeSizeByAspectRatio;
        ...
        protected virtual void OnEnable()
        {
			...
			_changeSizeByAspectRatio = serializedObject.FindProperty("_changeSizeByAspectRatio");
        ...
        public override void OnInspectorGUI()
        {
			...
			EditorGUILayout.PropertyField(_changeSizeByAspectRatio);
