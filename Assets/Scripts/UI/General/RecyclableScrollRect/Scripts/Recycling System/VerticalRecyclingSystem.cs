...
namespace PolyAndCode.UI
{
    ...
    public class VerticalRecyclingSystem : RecyclingSystem
    {
		...
		private bool _changeSizeByAspectRatio = true;

		#region INIT
		public VerticalRecyclingSystem(RectTransform prototypeCell, RectTransform viewport, RectTransform content, IRecyclableScrollRectDataSource dataSource,
			bool isGrid, int coloumns, bool changeSizeByAspectRatio)
        {
			...
			_changeSizeByAspectRatio = changeSizeByAspectRatio;
        ...
        public override IEnumerator InitCoroutine(Action onInitialized)
        {
            ...
            //SetUI content height according to no of rows
        ...
        private void CreateCellPool()
        {
            ...
            //SetUI the prototype cell active and set cell anchor as top 
