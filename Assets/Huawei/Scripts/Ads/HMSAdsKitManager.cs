...
public class HMSAdsKitManager : HMSSingleton<HMSAdsKitManager>
{
    ...
    public void ShowBannerAd()
    {
        if (bannerView == null)
        {
            Debug.LogWarning("[HMS] HMSAdsKitManager Banner Ad is Null.");
            return;
        }
        bannerView.ShowBanner();
    }
    ...
    public void LoadInterstitialAd(bool force = false)
    {
        if (!isInitialized || !adsKitSettings.GetBool(HMSAdsKitSettings.EnableInterstitialAd))
			return;

		if (!force && IsInterstitialAdLoaded)
			return;
    ...
    public void ShowInterstitialAd()
    {
        ...
        if (interstitialView?.Loaded == true)
        {
            ...
            Debug.LogWarning("[HMS] HMSAdsKitManager Interstitial Ad Still Not Loaded Yet!");
	}
    ...
    private class InterstitialAdListener : IAdListener
    {
        ...
        public void OnAdClosed()
        {
			...
			mAdsManager.OnCloseInterstitial();
			mAdsManager.OnInterstitialAdClosed?.Invoke();
            //mAdsManager.LoadInterstitialAd(force: true);
        }
    ...
    public void ShowRewardedAd()
    {
        ...
        {
            Debug.LogWarning("[HMS] HMSAdsKitManager Rewarded Ad still not loaded");
        }
    }
    ...
    private class RewardAdListener : IRewardAdStatusListener
    {
        ...
        public void OnRewardAdClosed()
        {
			...
			mAdsManager.OnCloseReward();
			mAdsManager.OnRewardAdClosed?.Invoke();
			//mAdsManager.LoadRewardedAd(force: true);
		}
