...
var LibraryWebSocket = {
  $textEncoder: new TextEncoder(),
	...
	WebSocketAllocate: function(url) {
		...
		window["webSocketState"] = webSocketState;
  ...
  WebSocketAddSubProtocol: function(instanceId, subprotocol) {
	...
	WebSocketFree: function(instanceId) {
		...
		/*if (webSocketState.debug)
            console.log("[JSLIB WebSocket] WebSocketFree try " + instanceId);*/
		...
		/*if (webSocketState.debug)
            console.log("[JSLIB WebSocket] WebSocketFree after " + instanceId);*/
	...
	WebSocketConnect: function(instanceId) {
		...
		instance.ws.onopen = function() {
			...
			if (webSocketState.debug)
				console.log("[JSLIB WebSocket] Socket " + instanceId + " connected.");
		...
		instance.ws.onmessage = function(ev) {
			...
			if (webSocketState.debug)
				console.log("[JSLIB WebSocket] Socket " + instanceId + " received message: ", ev.data);
		...
		instance.ws.onerror = function(ev) {
			...
			if (webSocketState.debug)
				console.log("[JSLIB WebSocket] Socket " + instanceId + " error occured. " + JSON.stringify(ev));
		...
		instance.ws.onclose = function(ev) {
			...
			if (webSocketState.debug)
				console.log("[JSLIB WebSocket] Socket " + instanceId + " closed.");
	...
	WebSocketClose: function(instanceId, code, reasonPtr) {
		...
		/*if (webSocketState.debug)
		    console.log("[JSLIB WebSocket] WebSocketClose try " + instanceId);*/
		...
		try {
			...
			/*if (webSocketState.debug)
                console.log("[JSLIB WebSocket] WebSocketClose after " + instanceId);*/
    ...
    * @param instanceId Instance ID
    */
    WebSocketGetURL: function(instanceId) {
