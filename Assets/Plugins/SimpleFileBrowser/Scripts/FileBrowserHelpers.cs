...
namespace SimpleFileBrowser
{
	public struct FileSystemEntry
	{
		...
		public FileSystemEntry(string path, string name, bool isDirectory)
		{
			Path = path;
			Name = name;
			NameWithoutExtension = isDirectory ? name : System.IO.Path.GetFileNameWithoutExtension(name);
		...
		public FileSystemEntry(FileSystemInfo fileInfo)
		{
			...
			Name = fileInfo.Name;
			NameWithoutExtension = System.IO.Path.GetFileNameWithoutExtension(fileInfo.Name);
